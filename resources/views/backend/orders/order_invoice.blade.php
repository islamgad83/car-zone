...
<html lang="en">
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            ...
            <!-- {{-- <img src="" alt="" width="150"/> --}} -->
                <h2 style="color: green; font-size: 26px;"><strong>EgyShop</strong></h2>
            </td>
            <td align="right">
                <pre class="font" >
                   EgyShop Head Office
                   Email:support@egyshop.com <br>
                   Phone: 01060838210 <br>
    ...
    <table width="100%" style=" padding:0 10px 0 10px;">
        <tr>
            <td align="right" >
                <h2><span style="color: green;">Subtotal:</span>{{ $order->amount }} EGP</h2>
                <h2><span style="color: green;">Total:</span> {{ $order->amount }} EGP</h2>
