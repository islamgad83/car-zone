                                            ...
                                            <div class="row"> <!-- start 5th row  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="product_color_ar" class="form-control"
                                                                   value="{{ $products->product_color_ar }}" data-role="tagsinput">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="rate" class="form-control" value="{{ $products->rate }}" required>
                                                            @error('rate')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="controls">
                                                            <label class="fancy-checkbox">
                                                                <input type="checkbox" id="checkbox_4" name="special_offer"
                                                                       value="1" {{ $products->special_offer == 1 ? 'checked': '' }} data-parsley-errors-container="#error-checkbox">
                                                                <span>Special Offer</span>
                                                            </label>
                                                            <br>
                                                            <label class="fancy-checkbox">
                                                                <input type="checkbox" id="checkbox_5" name="special_deals"
                                                                       value="1" {{ $products->special_deals == 1 ? 'checked': '' }} data-parsley-errors-container="#error-checkbox">
                        ...
                        <div class="col-md-12">
                            <div class="box bt-3 border-info">
                                ...
                                <form method="post" action="{{ route('update-product-image') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="text-xs-right">
                                        <input type="submit" class="btn btn-rounded btn-warning mb-5" value="Update Image">
                                    </div>
                                    <br><br>
                                </form>
                            </div>
