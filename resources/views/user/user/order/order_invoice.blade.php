...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        ...
        <!-- {{-- <img src="" alt="" width="150"/> --}} -->
            <h2 style="color: green; font-size: 26px;"><strong>Carzone Shop</strong></h2>
            <img src="{{asset('user/images/logo.png')}}" alt="" style="width: 10%">
        </td>
        <td align="right">
            <pre class="font" >
               Carzone Head Office
               Email:support@carzone.com <br>
               Phone: 01011477900 <br>
                El-Maadi,11728, Cairo <br>
...
<table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span>{{ $order->amount }} EGY</h2>
            <h2><span style="color: green;">Total:</span>{{ $order->amount }} EGY</h2>
