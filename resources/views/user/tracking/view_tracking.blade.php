        ...
        <article class="card">
            ...
            <div class="card-body">
                ...
                <div class="row" style="margin-left: 30px; margin-top: 20px;">
                    <div class="col-md-2">
                        <b> {{__('user.InvoiceNumber')}} </b><br>
                        {{ $track->invoice_no }}
                    </div> <!-- // end col md 2 -->

                    <div class="col-md-2">
                        <b>{{__('user.OrderDate')}} </b><br>
                        {{ $track->order_date }}
                    </div> <!-- // end col md 2 -->

                    <div class="col-md-2">
                        <b> {{__('user.ShippingBy')}} - {{ $track->name }} </b><br>
                        {{ $track->division->division_name }} / {{ $track->district->district_name }}
                    </div> <!-- // end col md 2 -->

                    <div class="col-md-2">
                        <b> {{__('user.User_Mobile_Number')}} </b><br>
                        {{ $track->phone }}
                    </div> <!-- // end col md 2 -->

                    <div class="col-md-2">
                        <b> {{__('user.payment_method')}}  </b><br>
                        {{ $track->payment_method  }}
                    </div> <!-- // end col md 2 -->

                    <div class="col-md-2">
                        <b> {{__('user.total')}}  </b><br>
                        {{ $track->amount  }} EGP
                    </div> <!-- // end col md 2 -->
