                                    ...
                                    <div class="blog-item">
                                        ...
                                        <div class="blog-detail">
                                            ...
                                            <div class="blog-title">
                                                <a href="{{ route('post.details',$blog->id) }}">@if(session()->get('language') == 'arabic') {{ $blog->post_title_ar }}
                                                    @else {{ $blog->post_title_en }} @endif </a>
                                                </div>
                                            ...
                                            <a href="{{ route('post.details',$blog->id) }}" class="btn btn-link btn-primary">(read more) </a>
